...
const SuccessModal = ({ isVisible, onCloseSuccess }) => {
    ...
    >
      <View style={styles.overlay}>
        <View style={styles.container}>
          <LottieView
            source={require('../assets/SuccessAnim.json')}  // Asegúrate de tener la animación en la carpeta assets
            autoPlay
            //loop={false}  // No se repite la animación
            style={styles.animation}
          />
          {/* <Text style={styles.text}>Reporte registrado exitosamente</Text> */}
